  ...
  return (
   ...
   <Box pos={"absolute"} display={"flex"}  alignItems={"center"}  top={"0%"} bgColor={"blackAlpha.700"}  left={"0%"} bottom={"0%"} right={"0%"} zIndex={15}>
    <VStack justifyContent={"flex-start"} alignItems={"flex-start"}>
        <Text mx={"20px"} color={"white"} fontSize={"30px"} fontWeight={"bold"}>Elemental</Text>
        <Text mx={"20px"} color={"white"} display={["none","block"]} w={"400px"}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, rerum numquam! Sed repudiandae qui dolor ab nihil quas, odio laborum autem nobis quae illum, temporibus veritatis perspiciatis itaque minima rerum!</Text>
